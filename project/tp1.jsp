              ...
              <form name="form1" method="post" action=""  onSubmit="return validate()">
                ...
                <table width="550" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="">
                  <tr>
                    ...
                    <td width="326"><input name="pd" type="text" id="pd" readonly="true" value="<%= id%>"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td><div class="style8" id="citydiv"><select name="eventname" id="eventname">
                        <option value="-1">Select Event</option> </select></div>
                      </td>
                  </tr>
                  <tr>
                    <td><span class="style11">Event 1 </span></td>
                    <td><input name="event1" type="text" id="event1" readonly="true">
                      <input name="Button" type="button" onClick="document.getElementById('event1').value='';" value="Clear"></td>
                  </tr>
                  <tr>
                    <td><span class="style11">Event 2 </span></td>
                    <td><input name="event2" type="text" id="event2" readonly="true">
                      <input name="Button" type="button" onClick="document.getElementById('event2').value='';" value="Clear"></td>
                  </tr>
                  <tr>
                    <td><span class="style11">Event 3 </span></td>
                    <td><input name="event3" type="text" id="event3" readonly="true">
                      <input name="Button" type="button" onClick="document.getElementById('event3').value='';" value="Clear"></td>
                  </tr>
                  <tr>
...
{
	boolean exist=false;
	String pid="",pname="",cname="",pclass="",rno="",gender="",tid="",eventname1="",eventname2="",eventname3="";
	//getting parameters from html controls
	...
	try
	{
		...
		{
			st.executeUpdate("Insert into tm_playerevent(pid,tid,eventname1,eventname2,eventname3)values('"+pid+"','"+tid+"','"+eventname1+"','"+eventname2+"','"+eventname3+"')");
